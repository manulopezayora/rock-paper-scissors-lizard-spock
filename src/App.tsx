  ...
  return (
    <div className="container">
      <header className="header">
        ...
        <div className="score">
          <p className="score__title">User score</p>
          <p id="user-score-value" className="score__value"></p>
        </div>
        <div className="score">
          <p className="score__title">cpu score</p>
          <p id="cpu-score-value" className="score__value"></p>
        </div>
      </header>
      ...
      <div className="rules" id="rules">
        <button data-action="open-rules" className="btn rules__btn">Rules</button>
        <div id="rules-modal" className="rules__modal">
          <div className="modal__content">
            ...
            <button data-action="close-rules" className="close-modal">+</button>
          </div>
        </div>
      </div>
    </div>
